...
export default function Drawer({ screen }) {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <Divider />
        <List>
          {["Add New Course", "All Students", "All Courses", "Sign Out"].map((text, index) => (
            <ListItem key={text} disablePadding>
              ...
              >
                <ListItemIcon>
                  {index === 0 ? <AddBoxIcon /> : index === 1 ? <AccountCircleIcon /> : index === 2 ? <CategoryIcon /> : <LogoutIcon />}
                </ListItemIcon>
